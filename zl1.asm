...
TicksThreshold    EQU 1000    ; Approximately 18.2 ticks per second * 40 seconds
ScoreTicksThreshold EQU 364  ; Approximately 18.2 ticks per second * 2 seconds
...
UpdateTimeAndScore PROC
    ...
    XOR AX, AX
    MOV [TickCounter], AX
    ; Decrement lives every 40 seconds
    DEC [Lives]
    CALL DisplayScoreLives
...
PlayShootSound PROC
    ...
    MOV AL, 0B6h
    OUT 43h, AL
    MOV AX, 15000  ; Frequency for the PC speaker (roughly 1000 Hz)
    OUT 42h, AL
    MOV AL, AH
    OUT 42h, AL
    IN AL, 61h
